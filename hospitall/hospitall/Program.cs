...
class Program
{
    ...
    static void Main(string[] args)
    {
        ...
        Doctor doctort3 = new Doctor("Qedir", "Eliyev", 4);
        doctorsT.Add(doctort1);
        doctorsT.Add(doctort2);
        doctorsT.Add(doctort3);
        ...
        Doctor doctors2 = new Doctor("Adil", "Adilov", 7);
        Doctor doctors3 = new Doctor("Veli", "Veliyev", 7);
        doctorsS.Add(doctors1);
        doctorsS.Add(doctors2);
        doctorsS.Add(doctors3);
